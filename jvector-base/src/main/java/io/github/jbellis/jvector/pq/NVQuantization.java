 ...
 */
public class NVQuantization implements VectorCompressor<ByteSequence<?>>, Accountable {
     ...
     */
    public static NVQuantization compute(RandomAccessVectorValues ravv, int M, int clusterCount, boolean globallyCenter) {
        return compute(ravv, M, clusterCount, globallyCenter, UNWEIGHTED, PhysicalCoreExecutor.pool(), ForkJoinPool.commonPool());
    }

    public static NVQuantization compute(RandomAccessVectorValues ravv, int M, int clusterCount, boolean globallyCenter, float anisotropicThreshold) {
     ...
     */
    public static NVQuantization compute(
            ...
            ForkJoinPool parallelExecutor)
    {
        ...
        return new NVQuantization(codebooks, clusterCount, subvectorSizesAndOffsets, globalCentroid, anisotropicThreshold);
    }
     ...
     */
    public NVQuantization refine(RandomAccessVectorValues ravv) {
                                 ...
                                 ForkJoinPool parallelExecutor)
    {
        ...
        return new NVQuantization(refinedCodebooks, clusterCount, subvectorSizesAndOffsets, globalCentroid, anisotropicThreshold);
    }

    NVQuantization(VectorFloat<?>[] codebooks, int clusterCount, int[][] subvectorSizesAndOffsets, VectorFloat<?> globalCentroid, float anisotropicThreshold) {
    ...
    public CompressedVectors createCompressedVectors(Object[] compressedVectors) {
        return new NVQVectors(this, (ByteSequence<?>[]) compressedVectors);
    }
    ...
    public static NVQuantization load(RandomAccessReader in) throws IOException {
        ...
        return new NVQuantization(codebooks, clusters, subvectorSizes, globalCentroid, anisotropicThreshold);
    }
