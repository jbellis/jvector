...
public class Bench {
    public static void main(String[] args) throws IOException {
        ...
        var mGrid = List.of(32, 48, 64, 96, 128); // List.of(16, 24, 32, 48, 64, 96, 128);
        var efConstructionGrid = List.of(100, 200, 300); // List.of(60, 80, 100, 120, 160, 200, 400, 600, 800);
        var efSearchGrid = List.of(1.0, 1.2, 1.5, 2.0);
        ...
        var coreFiles = List.of("colbert-10M");
