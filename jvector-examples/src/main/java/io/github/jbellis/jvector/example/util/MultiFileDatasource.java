...
public class MultiFileDatasource {
    ...
    public static Map<String, MultiFileDatasource> byName = new HashMap<>() {{
        ...
        put("colbert-10M", new MultiFileDatasource("colbert-10M",
                                                   "wikipedia_squad/10M/09062024/colbertv2.0_128_base_vectors_10000000.fvec",
                                                   "wikipedia_squad/10M/09062024/colbertv2.0_128_query_vectors_100000.fvec",
                                                   "wikipedia_squad/10M/09062024/colbertv2.0_128_indices_b10000000_q100000_k100.ivec"));
