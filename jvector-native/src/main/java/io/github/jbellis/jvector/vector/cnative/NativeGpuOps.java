...
public class NativeGpuOps {
    ...
    private static class load_query {
        public static final FunctionDescriptor DESC = FunctionDescriptor.of(
            NativeGpuOps.C_POINTER,
            NativeGpuOps.C_POINTER,
            NativeGpuOps.C_POINTER
        ...
        public static final MethodHandle HANDLE = Linker.nativeLinker().downcallHandle(
                    NativeGpuOps.findOrThrow("load_query"),
                    DESC, Linker.Option.critical(true));
    }
     ...
     * }
     */
    public static FunctionDescriptor load_query$descriptor() {
        return load_query.DESC;
    }
     ...
     * }
     */
    public static MethodHandle load_query$handle() {
     ...
     * }
     */
    public static MemorySegment load_query(MemorySegment dataset, MemorySegment query) {
        var mh$ = load_query.HANDLE;
        try {
            if (TRACE_DOWNCALLS) {
                traceDowncall("load_query", dataset, query);
            }
    ...
    private static class free_jpq_query {
        public static final FunctionDescriptor DESC = FunctionDescriptor.ofVoid(
            NativeGpuOps.C_POINTER
        );

        public static final MethodHandle HANDLE = Linker.nativeLinker().downcallHandle(
                    NativeGpuOps.findOrThrow("free_jpq_query"),
                    DESC, Linker.Option.critical(true));
    }
     ...
     * }
     */
    public static FunctionDescriptor free_jpq_query$descriptor() {
        return free_jpq_query.DESC;
    }
     ...
     * }
     */
    public static MethodHandle free_jpq_query$handle() {
        return free_jpq_query.HANDLE;
    }
    /**
     * {@snippet lang=c :
     * void free_jpq_query(jpq_query_t *query_handle)
     * }
     */
    public static void free_jpq_query(MemorySegment query_handle) {
        var mh$ = free_jpq_query.HANDLE;
        try {
            if (TRACE_DOWNCALLS) {
                traceDowncall("free_jpq_query", query_handle);
            }
